...
var typingText = document.querySelector(".typing-text p"),
...
function initTyping() {
  var characters = typingText.querySelectorAll("span");
  var typedChar = inpField.value.split("")[charIndex];
